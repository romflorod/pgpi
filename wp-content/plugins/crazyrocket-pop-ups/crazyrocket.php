<?php
    ...
    Description: Optin Wheel, Slot and Scratch card Popup for WooCommerce! Grow your email list and boost sales.
    Version: 1.0.0
    Author: CrazyRocket
    License: GPL2
    Copyright 2018 Andrea De Santis (email : hello@crazyrocket.io)
...
<?php
        ...
        public function embedCrazyRocket()
        {
            ...
            $loadscript = "https://z8k8b4s9.stackpathcdn.com/widget/scripts/crazyrocket.start.js?id=".  $code;
