...
class VI_WOO_LUCKY_WHEEL_Admin_Admin {
	...
	public function preview_wheel_ajax() {
		...
		$coupon_type   = isset( $_GET['coupon_type'] ) ? $_GET['coupon_type'] : array();
		$coupon_amount = isset( $_GET['coupon_amount'] ) ? $_GET['coupon_amount'] : array();
		$labels        = array();
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <input type="text" id="show_wheel" name="show_wheel"
                                       value="<?php echo $this->settings->get_params( 'notify', 'show_wheel' ); ?>"><?php esc_html_e( 'Enter min,max to set random between min and max (seconds).', 'woo-lucky-wheel' ); ?>
                            </td>
                        </tr>
                                ...
                                <div class="inline fields">
                                    ...
                                    <input type="hidden" name="wheel_label_coupon" id="wheel_label_coupon"
                                           ...
                                           value="<?php if ( $this->settings->get_params( 'wheel', 'label_coupon' ) ) {
										       echo $this->settings->get_params( 'wheel', 'label_coupon' );
									       } ?>">
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="slice_text_color" id="slice_text_color" type="text"
                                       class="color-picker"
                                       value="<?php echo $this->settings->get_params( 'wheel', 'slice_text_color' ); ?>"
                                       style="background-color: <?php echo $this->settings->get_params( 'wheel', 'slice_text_color' ); ?>;"/>
                            </td>
                        </tr>
                        </tbody>
                            ...
                            <tr class="wheel_col">
                                ...
                                <td class="wheel_col_coupons_value">
                                    <input type="text" name="custom_type_label[]"
										<?php
										echo ' class="custom_type_label" value="' . ( ( isset( $this->settings->get_params( 'wheel', 'custom_label' )[ $count ] ) && $this->settings->get_params( 'wheel', 'custom_label' )[ $count ] ) ? $this->settings->get_params( 'wheel', 'custom_label' )[ $count ] : $this->settings->get_params( 'wheel', 'label_coupon' ) ) . '"';
										?> placeholder="Label"/>
                                </td>
                                <td class="wheel_col_coupons_value">
                                    <input type="number" name="coupon_amount[]" min="0"
                                           ...
                                           value="<?php echo $this->settings->get_params( 'wheel', 'coupon_amount' )[ $count ]; ?>"
                                    ...
                                    <div class="wlwl_existing_coupon"
                                        ...
                                        <select name="wlwl_existing_coupon[]"
											...
											if ( isset( $this->settings->get_params( 'wheel', 'existing_coupon' )[ $count ] ) && '' !== $this->settings->get_params( 'wheel', 'existing_coupon' )[ $count ] ) {
												echo '<option value="' . $this->settings->get_params( 'wheel', 'existing_coupon' )[ $count ] . '" selected>' . ( isset( get_post( $this->settings->get_params( 'wheel', 'existing_coupon' )[ $count ] )->post_title ) ? get_post( $this->settings->get_params( 'wheel', 'existing_coupon' )[ $count ] )->post_title : "" ) . '</option>';
											} else {
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li>{shop_now}
                                        - <?php echo '<a class="wlwl-button-shop-now" href="' . ( $this->settings->get_params( 'button_shop_url' ) ) . '" target="_blank" style="text-decoration:none;display:inline-block;padding:10px 30px;margin:10px 0;font-size: 16px;color:#ffffff;background:#000;">' . esc_html__( 'Shop now', 'woo-lucky-wheel' ) . '</a>' ?></li>
                                </ul>
                            </td>
                        </tr>
                        <tr valign="top">
                            ...
                            <td>
                                <div class="inline fields">
                                    <input type="number" min="1" name="wlwl_expiry_date" id="wlwl_expiry_date"
                                           value="<?php echo $this->settings->get_params( 'coupon', 'expiry_date' ) ?>"><?php esc_html_e( 'Days', 'woo-lucky-wheel' ) ?>
                                </div>
                        ...
                        <tr class="wlwl-custom-coupon">
                            ...
                            <td>
                                <input type="text" class="short wc_input_price" name="wlwl_min_spend"
                                       id="wlwl_min_spend"
                                       value="<?php echo $this->settings->get_params( 'coupon', 'min_spend' ); ?>"
                        ...
                        <tr class="wlwl-custom-coupon">
                            ...
                            <td>
                                <input type="text" class="short wc_input_price" name="wlwl_max_spend"
                                       id="wlwl_max_spend"
                                       value="<?php echo $this->settings->get_params( 'coupon', 'max_spend' ); ?>"
                        ...
                        <tr class="wlwl-custom-coupon">
                            ...
                            <td>
                                <input type="number" class="short" name="wlwl_limit_per_coupon"
                                       ...
                                       value="<?php echo $this->settings->get_params( 'coupon', 'limit_per_coupon' ) ?>"
                        ...
                        <tr class="wlwl-custom-coupon">
                            ...
                            <td>
                                <input type="number" class="short" name="wlwl_limit_to_x_items"
                                       ...
                                       value="<?php echo $this->settings->get_params( 'coupon', 'limit_to_x_items' ) ?>"
                        ...
                        <tr class="wlwl-custom-coupon">
                            ...
                            <td>
                                <input type="number" class="short" name="wlwl_limit_per_user"
                                       ...
                                       value="<?php echo $this->settings->get_params( 'coupon', 'limit_per_user' ) ?>"
                        ...
                        <tr class="wlwl-custom-coupon">
                            ...
                            <td>
                                <input id="wlwl_coupon_code_prefix" type="text" name="wlwl_coupon_code_prefix"
                                       value="<?php echo $this->settings->get_params( 'coupon', 'coupon_code_prefix' ) ?>">
                            </td>
                        </tr>
                        </tbody>
                    </table>
		...
		if ( isset( $_POST['submit'] ) || isset( $_POST['wlwl_check_key'] ) ) {
			...
			for ( $i = 0; $i < sizeof( $args['wheel']['coupon_type'] ); $i ++ ) {
				if ( $args['wheel']['coupon_type'][ $i ] == 'non' ) {
					...
					if ( $args['wheel']['coupon_amount'][ $i ] < 1 ) {
						add_action( 'admin_notices', function () {
							?>
                            <div class="error">
                                <p><?php esc_html_e( 'The amount of Valued-coupon must be greater than zero!', 'woocommerce-photo-reviews' ) ?></p>
                            </div>
							<?php
						} );
						$validate = false;
...
//die;
  ...
  "bluegrey": {
    ...
    "600": "#546e7a"
		...
		echo '</div>';
		echo '<div class="auto_color_ok_cancel"><div class="vi-ui buttons"><span class="auto_color_ok positive vi-ui button">' . esc_html__( 'OK', 'woo-lucky-wheel' ) . '</span>';
		echo '<div class="or"></div><span class="auto_color_cancel vi-ui button">' . esc_html__( 'Cancel', 'woo-lucky-wheel' ) . '</span></div></div>';
	}
}